...
def ask_questions():
    ...
    questions = ["What animals are pearls found in?", "Google Chrome, Safari, Firefox, and Explorer are different types of what?",
                 ...
                 "What is the slogan of Apple Inc.?", "In which year World War I begin?", "Thor was the son of which God?", "How many cards are there in a deck of Uno?",
                 ...
                 "What is the Hebrew term for “commandment”?", "What’s another name for a footrest?", "Broadway was established in what year in New York?",
